    ...
    context(`User Validation`, () => {
      ...
      it(`responds 400 'Password must be equal to or longer than 8 characters.' when empty password`, () => {
        ...
        return supertest(app)
          ...
          .expect(400, { error: `Password must be equal to or longer than 8 characters.` })
      })
      ...
      it(`responds 400 error when password isn't complex enough`, () => {
        ...
        return supertest(app)
          ...
          .expect(400, { error: `Password must contain an upper case letter, a lower case letter and a number.` })
      })
      ...
      it(`responds 400 'User with that email address already exists in our system.' when email isn't unique`, () => {
        ...
        return supertest(app)
          .post('/api/users')
          .send(duplicateUser)
          .expect(400, { error: `User with that email address already exists in our system.` })
      })
    })
